...
function HeroSection() {
  ...
  return (
    <section
      id="inicio"
      className="relative min-h-screen flex flex-col pt-[80px] overflow-hidden"
    >
      ...
      {/* Invitación Personalizada Edge-to-Edge en el flujo normal (Empuja el contenido central hacia abajo) */}
      <AnimatePresence>
        {invitation?.guestName && (
          ...
          >
            <div className="bg-black/70 backdrop-blur-md w-full border-b border-primary/40 shadow-[0_10px_40px_rgba(0,0,0,0.5)] py-6 mb-8 md:mb-16">
              <motion.div
                initial={{ scale: 0 }}
                animate={{ scale: 1 }}
            ...
            <Card className="border-primary/20 hover:border-primary/50 transition-all duration-300 h-full bg-white/50 backdrop-blur-sm shadow-sm hover:shadow-md overflow-hidden">
              ...
              <div className="relative w-full h-56 md:h-72 overflow-hidden">
                ...
                <div className="absolute bottom-4 left-6 md:left-10">
                  <h3 className="font-serif text-2xl md:text-3xl font-semibold text-white drop-shadow-lg">
